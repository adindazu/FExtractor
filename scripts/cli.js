...
const contractABI = require("../artifacts/contracts/F0extractor.sol/F0extractor.json").abi;

program
    .name("f0extractor-cli")
    .description("CLI tool for F0extractor smart contract")
    .version("1.0.0");
