 ...
 * This file demonstrates how to integrate F0extractor with a web frontend
 */

// For React/Vue/Angular applications
export class F0extractorClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new F0extractorClient(provider, contractAddress);
